        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                My background in business and technology lets me connect with both the product and the people using it. I see product marketing as teaching, aiming to help people realize why a product truly matters.
              </p>
            </motion.div>
