        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12 md:mb-20">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Currently, I lead the product marketing function at Trezor, the original <BitcoinWord /> hardware wallet company. I focus on guiding PMM strategy and our team to make crypto and hardware security simple and accessible. Before Trezor, I spent years in the analytics space at GoodData, the leading AI-powered cloud analytics platform, and helped build the product marketing community here in Prague, one of Europe's rising tech hubs.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
