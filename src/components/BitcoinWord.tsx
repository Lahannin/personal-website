  ...
  ({ children = "Bitcoin" }, ref) => {
    ...
    return (
      <span
        ...
        className="relative inline-block transition-all duration-300 hover:text-[hsl(var(--bitcoin-orange))] hover:[text-shadow:0_0_12px_rgba(247,147,26,0.5),0_0_24px_rgba(247,147,26,0.25)]"
      >
        {children}
      </span>
    );
