    ...
    <section id="contact" aria-labelledby="contact-heading" className="py-28 md:py-36 relative overflow-hidden bg-secondary/30" data-description="Contact Lauri Hänninen via X (@Lahannin), LinkedIn (/in/laurihanninen), or Telegram (@lahannin)">
      ...
      <div className="container px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <span className="font-mono text-primary dark:text-highlight text-[10px] font-bold tracking-[0.25em] uppercase">// CONTACT</span>
          ...
          >
            {links.map((link, index) => (
              <a
                ...
                className="group p-4 sm:p-6 min-h-[80px] sm:min-h-[100px] border-gradient rounded-xl shadow-md border border-border/40 hover:border-primary/50 dark:hover:border-highlight/50 hover:-translate-y-2 hover:shadow-xl focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 transition-all duration-300"
