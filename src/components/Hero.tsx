      ...
      <motion.div style={{ y: contentY, opacity }} className="container relative z-10 px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex justify-center mb-10 -mt-8 md:mt-20">
              <div className="relative group cursor-pointer" onClick={handlePhotoClick} style={{ cursor: "url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"32\" height=\"32\" viewBox=\"0 0 32 32\"><text y=\"24\" font-size=\"24\">₿</text></svg>') 16 16, pointer" }}>
