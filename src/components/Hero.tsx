...
const Hero = () => {
  ...
  const handlePhotoClick = useCallback((e: React.MouseEvent) => {
    ...
    if (count >= 5 && !spinTriggered) {
      ...
      setHaloScale(0);
      // Store "hero" so back button scrolls to top
      sessionStorage.setItem("secretReturnSection", "hero");
      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <a
              href="#about"
              className="group px-8 sm:px-10 py-4 sm:py-5 min-h-[52px] flex items-center justify-center bg-foreground text-background font-bold rounded-lg shadow-lg hover:shadow-highlight/20 hover:scale-[1.03] transition-[transform,box-shadow] duration-300 text-base sm:text-lg tracking-tight"
            >
              About Me
              <m.span
                whileInView={{ y: [0, 3, 0] }}
