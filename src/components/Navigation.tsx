            ...
            <div className="flex items-center justify-end h-16 md:h-20">
              <div className="hidden md:flex items-center gap-0.5">
                {navLinks.map((link) => (
                  <a
                    key={link.href}
                    href={link.href}
                    className="px-4 py-2 text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground hover:text-primary dark:hover:text-highlight focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-md transition-colors font-mono"
                  >
                    {link.label}
                  </a>
                ))}
                <button
                  ...
                  className="ml-2 p-1.5 min-w-[32px] min-h-[32px] flex items-center justify-center rounded-md text-muted-foreground hover:text-primary dark:hover:text-highlight border border-border/50 hover:border-primary/40 dark:hover:border-highlight/40 transition-all duration-300 font-mono"
                >
              ...
              <div className="md:hidden flex items-center gap-1">
                <button
                  onClick={toggleDark}
                  aria-label={isDark ? "Switch to light mode" : "Switch to dark mode"}
                  className="p-3 min-w-[44px] min-h-[44px] flex items-center justify-center text-muted-foreground hover:text-primary dark:hover:text-highlight rounded-lg transition-colors"
                >
